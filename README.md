...
## 🧑‍💻 About me
I am a **state-certified electrical technician** and **programmer**, and I consider myself an enthusiast for **Linux**, **smart homes**, and **free and open-source software (FOSS)**.

Over the past few years, I have acquired extensive knowledge of various programming languages and am always open to new platforms, technologies, and languages.

I currently use the following platforms, operating systems, tools, and programming languages:

![Languages and Frameworks](https://skills.syvixor.com/api/icons?i=android,bash,cloudflare,cpp,debian,docker,github,githubactions,grafana,homeassistant,javascript,linux,powershell,python,raspberrypi,visualstudiocode,vmware,yaml&perline=9)
...
- [`gPodder2Go`](https://github.com/dontobi/gpodder2go) Docker Container for gPodder2Go (AMD64, ARM64)
- [`SpamCalllist`](https://github.com/dontobi/SpamCalllist) Phone numbers for blacklists
- [`SpeedFlux.rpi`](https://github.com/dontobi/SpeedFlux.rpi) Docker Container for Speedflux (ARMv7, ARM64)
...
## 📊 GitHub Stats
<img src="https://github-readme-stats-one-bice.vercel.app/api?username=dontobi&show_icons=true&theme=github_dark&hide_border=true&count_private=true" />
